...
import { MetricCard, ChartOptions, DonutChartOptions } from '../../../reports/franchise-report/franchise-report.component';
...
export class ShelfDetailsComponent {
  ...
  // Esses dados serão pegos pelo id, o ID estará na URL
  topMetrics: MetricCard[] = [
    {
      label: "Média de resgate",
      value: "5.0",
      percentage: "50,2%",
      isNegative: true,
      iconColor: "#ffffff",
  ...
  qualityMetric: MetricCard[] = [
    ...
    {
      label: "Comercialização/Oferta de produtos",
      value: "4.8",
      percentage: "50,2%",
      isNegative: true,
      iconColor: "#ffffff",
