...
import { MultipleFilterTableComponent, ViewMode, FilterOption } from "../../../../../shared/components/multiple-filter-table/multiple-filter-table.component"
...
export class ListComponent implements OnInit {
  ...
  public displayedColumns: TableColumn[] = [
    ...
    { label: '', key: 'approvation', type: 'approvation' },
  ];
  ...
  private getCampaigns(search?: string) {
    ...
    for(let i = 0; i < 10; i++) {
      data.push({
        ...
        sendes: '000',
        impacteds: '000',
        status: i % 2 === 0 ? "Aprovado" : "Aguardando"
      })
    }
